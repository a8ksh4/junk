...
LAST = (3, 3)
BASE_BOARD[LAST[0]][LAST[1]] = False
BOARDS = []
for x in range(33):
...
def applyMove(move):
    ...
    #    print SPOTS
    for x,y in SPOTS:
        print "num:", countBoard(), "x,y:", x,y, "levels:", LEVEL, LEVEL+1
...
def genNext():
    ...
    #if ((numLeft <= LIMIT and LAST is False) or
    #    (numLeft <= LIMIT and BOARDS[LEVEL][LAST[0]][LAST[1]] == True)):
    if (numLeft <= LIMIT):
